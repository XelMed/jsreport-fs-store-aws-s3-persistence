...
module.exports = ({ logger, accessKeyId, secretAccessKey, bucket, lock = { }, options = {} }) => {
  ...
  if (!secretAccessKey && !options.secretAccessKey) {
  ...
  if (!options.accessKeyId) options.accessKeyId = accessKeyId
  if (!options.secretAccessKey) options.secretAccessKey = secretAccessKey
